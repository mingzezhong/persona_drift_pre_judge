...
| 2026-08-31 | G1 reviewer amendment-6 synthetic smoke and promotion | PASS | Five frozen reviewer/writer slots accepted 23/23 fresh synthetic tasks with zero invalid outputs after scalar administrative aliases were removed from model-visible input; production registry `configs/g1_reviewer_registry_production_amendment_6_v2_3.yaml` was promoted and hash-bound. |
| 2026-08-31 | G1 production Persona scalar recalibration 1 | **FAIL CLOSED — STOP AND AMEND** | Three independent primaries accepted 81/81 new records and blind-repeat exact agreement passed at 9/9 = 1.000, but pooled ordinal Krippendorff alpha was 0.139 < 0.67 and every dimension was below 0.50. The single frozen recalibration cycle is consumed; active pair packet remains absent and pair review did not start. Evidence: `data/reports/g1_persona_scalar_recalibration_1_failure_v2_3.json`. |
